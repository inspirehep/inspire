    ...
    <article>
      <front>
        <article-meta>
          ...
          <journal>
          	<publication>
            	<xsl:value-of select="fn:eval_bibformat(controlfield[@tag=001],'&lt;BFE_INSPIRE_PUBLI_INFO date_format=&quot;%Y&quot;>')" />
			</publication> 
  			<xsl:for-each select="datafield[@tag='773' and @ind1=' ' and @ind2=' ']">
