...
#'<a href="/search?ln=en&cc=Institutions&ln=en&cc=Institutions&p=110__u%3A%22' + author['a'] + '%22&action_search=Search&sf=&so=d&rm=&rg=25&sc=0&of=hd">'
    for author in authors:
        if author.has_key('a'):
            output += '<tr><td>' + '<a href="/search?ln=en&cc=Institutions&ln=en&cc=Institutions&p=110__u%3A%22' + author['a'] + '%22&action_search=Search&sf=&so=d&rm=&rg=25&sc=0&of=hd">' + author['a'] + '</a>'  + '</td><td>' + author['r'] + '</td><td>' + author['s'] + '</td><td>' + author['t'] + '</td></tr>'
