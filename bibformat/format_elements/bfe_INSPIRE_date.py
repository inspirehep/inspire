...
def get_date(bfo):
    """
    Returns datestruct for best available date. Returns None if none found.
...
def parse_date(datetext):
    """
    Reads in a date-string of either native spires (YYYYMMDD) or invenio style
    (YYYY-MM-DD). Then as much of the date as we have is returned in a tuple.
