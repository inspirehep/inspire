...
def check_record(record):
    ...
    if all_a_keys:
        ...
        first_key = all_z_keys[0]
        message = "Move TexKey from z to a: %s" % first_key[1]
        record_modify_subfield(record, "035", "a", first_key[1],
           first_key[0][2], field_position_local=first_key[0][1])
