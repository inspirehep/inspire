...
270::REPL(EOL,)::MINLW(82)---<datafield tag="270" ind1=" " ind2=" "><subfield code="m"><:CONFSUBMIT_EMAI::CONFSUBMIT_EMAI:></subfield><subfield code="p"><:CONFSUBMIT_CONT::CONFSUBMIT_CONT:></subfield></datafield>
8564u::REP(EOL,)::MINLW(82)---<datafield tag="856" ind1="4" ind2=" "><subfield code="u"><:CONFSUBMIT_URL::CONFSUBMIT_URL:></subfield></datafield>
111_start::REPL(EOL,)::DEFP()---<datafield tag="111" ind1=" " ind2=" ">
111a::REPL(EOL,)::MINLW(31)---<subfield code="a"><:CONFSUBMIT_TITL::CONFSUBMIT_TITL:></subfield>
111x::REPL(EOL,)::MINLW(33)---<subfield code="x"><:CONFSUBMIT_SDAT::year:>-<:CONFSUBMIT_SDAT::mm:>-<:CONFSUBMIT_SDAT::dd:></subfield>
111y::REPL(EOL,)::MINLW(33)---<subfield code="y"><:CONFSUBMIT_FDAT::year:>-<:CONFSUBMIT_FDAT::mm:>-<:CONFSUBMIT_FDAT::dd:></subfield>
